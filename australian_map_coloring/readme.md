...
This code is a simple implementation of the **Map Coloring Problem**.
...
###  3. Validation  
Before moving forward, it checks if any neighboring states already have this color?  
...
When you run `austraila_csp_solver.py`, you’ll see a clean and readable table in your terminal like this:
